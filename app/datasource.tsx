...
export const eventsData = [
    ...
    { 
        ...
        endDate: new Date("01/28/2025"),
        description: "elBookingh Booking" ,
        startTime: "6:30",
        endTime:"13:00",
        allDay:false
    },
